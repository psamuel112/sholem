...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    founderBio: Schema.Attribute.Text;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Company details, contact info and site-wide defaults';
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaBackground: Schema.Attribute.Media<'images'>;
    ...
    featuredProperties: Schema.Attribute.Relation<
      'oneToMany',
      'api::property.property'
    >;
    featuredPropertiesSubtitle: Schema.Attribute.Text;
    featuredPropertiesTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Featured Properties'>;
    ...
    > &
      Schema.Attribute.Private;
    locationsSubtitle: Schema.Attribute.Text;
    locationsTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Top Locations'>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
...
export interface ApiInquiryInquiry extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Contact and property enquiries submitted from the website';
    displayName: 'Inquiry';
  ...
  attributes: {
    ...
    preferredLocation: Schema.Attribute.String;
    ...
    type: Schema.Attribute.Enumeration<
      ['general', 'property', 'service', 'property-request']
    > &
...
export interface ApiOfferTypeOfferType extends Struct.CollectionTypeSchema {
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Real estate news and investment tips';
    displayName: 'News & Tip';
    pluralName: 'posts';
    singularName: 'post';
  };
  options: {
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    extraSpecs: Schema.Attribute.Component<'property.spec', true>;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    featuredImage: Schema.Attribute.Media<'images'>;
    features: Schema.Attribute.Relation<'manyToMany', 'api::feature.feature'>;
    gallery: Schema.Attribute.Media<'images', true>;
    initialDeposit: Schema.Attribute.String;
    landmarks: Schema.Attribute.Component<'property.spec', true>;
    ...
    offerTypes: Schema.Attribute.Relation<
      'manyToMany',
      'api::offer-type.offer-type'
    >;
    paymentPlan: Schema.Attribute.Text;
    plotSize: Schema.Attribute.String;
    price: Schema.Attribute.BigInteger;
    priceLabel: Schema.Attribute.String;
    propertyTypes: Schema.Attribute.Relation<
      'manyToMany',
      'api::property-type.property-type'
    >;
    publishedAt: Schema.Attribute.DateTime;
    ...
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    titleDocument: Schema.Attribute.String;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    description: Schema.Attribute.RichText;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    highlights: Schema.Attribute.Component<'shared.value-item', true>;
